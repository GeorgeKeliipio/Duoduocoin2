#############################################################################
# Makefile for building: nu
# Generated by qmake (2.01a) (Qt 4.8.5) on: ??? ?? 17 22:57:23 2015
# Project:  nu.pro
# Template: app
# Command: c:/Qt/4.8.5/bin/qmake.exe USE_UPNP=- -o Makefile nu.pro
#############################################################################
...
Makefile: nu.pro  ../QT/4.8.5/mkspecs/default/qmake.conf ../QT/4.8.5/mkspecs/features/device_config.prf \
	...
	$(QMAKE) USE_UPNP=- -o Makefile nu.pro
...
genbuildhook: FORCE
	cd C:/nubit; /bin/sh share/genbuild.sh C:/nubit/build/build.h
