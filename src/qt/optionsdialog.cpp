        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start DDS on window system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start DDS after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the DDS client port on the router. This only works when your router supports UPnP and it is enabled."));
    layout->addWidget(map_port_upnp);

    connect_socks4 = new QCheckBox(tr("&Connect through SOCKS4 proxy:"));
    connect_socks4->setToolTip(tr("Connect to the DDS network through a SOCKS4 proxy (e.g. when connecting through Tor)"));
