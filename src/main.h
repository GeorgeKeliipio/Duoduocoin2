...
static const int64 MIN_SHARE_TX_FEE = CENT;//COIN;
...
static const int COINBASE_MATURITY  = 10; // Must be smaller than PROOF_OF_WORK_BLOCKS
static const int COINSTAKE_MATURITY = 1500;//1500;//100; // Same average time as Peercoin (500 * 10 minutes vs 5000 * 1 minute)
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 60*10; // 60 second block spacing for Nubit
static const int STAKE_MIN_AGE = 60 * 60 * 24 * 1; // 60 * 60 * 24 * 1; // changed to 7 days so only one vote in 10000 block voting period can be made
static const int STAKE_MAX_AGE = STAKE_MIN_AGE + 1; // changed to same as minimum to incentivize minting as soon as possible
static const int64 IPO_SHARES = 1200000 * COIN; // Total number of shares to create using proof of work (intented for IPO)
...
static const int64 PARK_RATE_VOTES = 200; // Number of blocks used in park rate median vote calculation
static const int64 PARK_RATE_PREVIOUS_VOTES = 1440; // Number of blocks used in the park rate increase limitation
static const unsigned int CUSTODIAN_VOTES = 5000;
static const int PARK_RATE_VOTE_DELAY = 12;
#else
static const int64 PARK_RATE_VOTES = 200;//2000; // Number of blocks used in park rate median vote calculation
static const int64 PARK_RATE_PREVIOUS_VOTES = 1440; // Number of blocks used in the park rate increase limitation
static const unsigned int CUSTODIAN_VOTES = 5000;	//10000 org.
static const int PARK_RATE_VOTE_DELAY = 60;
#endif
static const int64 MOTION_VOTES = 10000;
static const int64 PROOF_OF_STAKE_REWARD = 0.3 * COIN;//40 * COIN; // Constant reward of Proof of Stake blocks
static const int64 MIN_COINSTAKE_VALUE = 100 * COIN;//10000 * COIN; // Minimum value allowed as input in a CoinStake
static const int64 MAX_COIN_AGE = 100000000000000; // To make sure coin days can be added about 10,000 times without overflow

#ifdef TESTING
static const int FEE_VOTE_DELAY_BLOCKS = 30;
static const int FEE_VOTES = 2000;
static const int SAFE_FEE_BLOCKS = 10;
#else
...
//#else
//static const std::string sAvailableUnits("S");
//#endif
...
inline int64 GetDefaultFee(unsigned char cUnit)
{
    switch (cUnit)
    {	
        case 'S': return (CENT/10);//COIN;	//dennis.
        case 'B': return (CENT/10);//CENT;
